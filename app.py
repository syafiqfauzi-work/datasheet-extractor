    ...
    if st.button("Extract Data", type="primary"):
        with st.spinner("Reading PDF and extracting data... Please wait."):
            try:
                ...
                - FOR "Temperature Coefficient": CRITICAL - T.C.R. often varies based on Resistance range! You MUST evaluate the exact decimal resistance of the MPN. For example, if the MPN contains "5R11", its resistance is 5.11 Ohms. Mathematically, 5.11 Ohms is strictly between 1 and 10. Therefore, you must select the T.C.R. value specifically assigned to the "1Ω ≤ R ≤ 10Ω" range, and IGNORE the values for R > 10Ω. Extract the numerical value TOGETHER WITH its unit (e.g., "200 ppm/°C"). Discard "±".
