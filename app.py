...
if uploaded_file is not None:
    if st.button("Extract Data", type="primary"):
        ...
        try:
            ...
            [GENERAL RULES]
            - FOR "Resistance (Ohm)": CRITICAL - If a target MPN is provided, you MUST decode the resistance directly from that MPN string based on the part number breakdown chart in the datasheet (e.g., extracting the 3-digit value and 1-digit multiplier). Do NOT blindly copy example part numbers explicitly written in the datasheet text (like MBB02070C1001FCT00 = 1K). Calculate the value yourself (e.g., '1828' means 182 x 10^-2 = 1.82 Ohms). Once calculated, format the extracted resistance value using the industry-standard R/K/M notation (e.g., 1.82 Ω becomes "1R82"). Do not output standard decimals.
