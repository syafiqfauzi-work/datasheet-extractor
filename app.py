...
if uploaded_file is not None:
    if st.button("Extract Data", type="primary"):
        ...
        try:
            ...
            - FOR "Power_Extraction_Logic": CRITICAL - IGNORE the general summary table on Page 1. You MUST scroll to the specific section titled "MAXIMUM RESISTANCE CHANGE AT RATED DISSIPATION AND OPERATING VOLTAGE". 1) Locate your exact package size (e.g., D12/CRCW0805). 2) Because PDF tables are flattened, the text will show the Standard and Extended wattages side-by-side sequentially (e.g., "0.125 W 0.25 W"). 3) Extract this exact string sequence. 4) The FIRST numeric value is ALWAYS the Standard mode. The SECOND is Extended. You MUST explicitly write down both, reject the second, and select the FIRST.
