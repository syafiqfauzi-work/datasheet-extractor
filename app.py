...
if uploaded_file is not None:
    if st.button("Extract Data", type="primary"):
        ...
        try:
            ...
            [GENERAL RULES]
            - FOR "Resistance_Calculation_Logic": If a target MPN is provided, you MUST perform these EXACT steps in order: 1) Extract the 4-digit resistance code (e.g., 1828). 2) Split into 3-digit Base (182) and 1-digit Multiplier (8). 3) Identify multiplier: '7'=*0.001, '8'=*0.01, '9'=*0.1, '0'=*1, '1'=*10, '2'=*100, '3'=*1000. 4) Multiply Base by Multiplier to get the exact decimal (e.g., 182 * 0.01 = 1.82). 5) Convert to R/K/M format by replacing the exact decimal point with R, K, or M. CRITICAL WARNING: Place the letter EXACTLY where the decimal dot is! 1.82 becomes "1R82" (NOT 18R2). 2.74 becomes "2R74". 22.1 becomes "22R1".
            - FOR "Resistance (Ohm)": Output ONLY the final R/K/M string from your calculation (e.g., "1R82"). ABSOLUTELY NO DECIMALS. If you output standard decimals like "1.82" here, it is WRONG.
